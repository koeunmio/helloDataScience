...
# 속성 관계 분석3 : (수치-수치형) hwy(고속도로)-cty(도시주행연비)
```{r}
...
# 탐색적 분석 : 세개 이상 속성 간 관계를 동시에 관찰(색상, 크기, 레이블 등)
...
ggplot(mpg.majors, aes(hwy, cty)) +  #기본 플롯
